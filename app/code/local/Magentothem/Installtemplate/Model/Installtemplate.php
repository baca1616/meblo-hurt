...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
        ...
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_lyra_wide', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_lyra_wide_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_lyra_wide', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'ma_lyra_wide_home', 'default', 0);
    }
